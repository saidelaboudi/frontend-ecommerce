                ...
                <div class="row">
                    <div class="col-lg-8 col-12">
                        <div class="checkout-form">
                            ...
                            <form class="form" onChange={onSubmit}>
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="textarea" name="name" placeholder="" required="required" />
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-md-6 col-12">
                                        <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="file" name="file" placeholder="" required="required" style={{ background: '#ffffff', width: '40% ', height: ' 40px', lineHeight: '20px' }} />
                                    </div>
                                </div>
                                <div class="button">
                                    <a type="submit" class="btn">Enregistrer</a>
                                </div>
                            </form>
                        </div>
                    </div>
